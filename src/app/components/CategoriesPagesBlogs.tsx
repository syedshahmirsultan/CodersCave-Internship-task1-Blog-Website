...
const CategoriesPagesBlogs = ({blogData} :{blogData :AllBlogType}) => {
    return  (<div className="px-uto py-auto lg:py-20 lg:px-10 flex flex-col gap-10 min-w-full">
    {
...
export default CategoriesPagesBlogs;
