...
const Hero = () => {
    return (
        ...
        <div className='relative'>
            ...
            <div className="absolute inset-0 bg-black/70 md:gap-y-8 gap-y-2 flex flex-col justify-center items-center text-white p-4 lg:pt-36 lg:px-18 h-full">
             ...
             <p className="text-yellow-300 text-xl font-semibold md:text-3xl lg:text-6xl pb-4 lg:pb-0 flex mx-auto mt-2 lg:mt-20 tracking-widest">Read. Write. Inspire.</p>
        </div>
    </div></div>
